...
class AddNewMovie extends StatefulWidget {
  final Movie movie;
  final int index;
  const AddNewMovie({Key key, this.movie, this.index}) : super(key: key);

  @override
  _AddNewMovieState createState() => _AddNewMovieState();
}
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          ...
                          Provider.of<MovieHelper>(context, listen: false).addMovie(movie);
